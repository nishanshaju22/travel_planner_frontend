...
const OPTIONS = [
  { 
    ...
    label: "Car / Rental", 
    icon: "🚗",
    description: "Drive yourself or rent a vehicle"
  },
  { 
    value: "PUBLIC", 
  ...
  { 
    ...
    label: "Air Travel", 
    icon: "✈️",
    description: "Flights and air transportation"
  },
  { 
    value: "TRAIN", 
    label: "Train", 
    icon: "🚄",
    description: "Rail and railway journeys"
  },
  { 
    value: "NONE", 
    label: "No Preference", 
    icon: "🌍",
    description: "Open to all transportation types"
  },
];
...
export default function TransportationPage() {
  ...
  const [selected, setSelected] = useState(preferences.transportationPreference || []);
  ...
  const next = () => {
    setPreference("transportationPreference", selected);
    router.push("/preferences/review");
  };

  const skip = () => {
    setPreference("transportationPreference", []);
    router.push("/preferences/review");
  };
  ...
  return (
    <OnboardingLayout 
      ...
      subtitle="Transportation Preferences"
    >
      <div className="mt-8 space-y-8">
        {/* Description */}
        <div>
          <p className="text-slate-600 leading-relaxed text-base" style={{ fontFamily: "'Inter', sans-serif" }}>
            Choose your preferred methods of transportation. Select all that apply.
          </p>
          {selected.length > 0 && (
